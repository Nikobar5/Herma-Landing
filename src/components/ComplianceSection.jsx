    ...
    <section className="py-24 bg-[var(--bg-primary)] overflow-hidden" id="compliance">
      <div className="container mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          {/* Privacy by Design */}
          <div className="bg-[var(--bg-secondary)] p-4 sm:p-6 rounded-xl border border-[var(--border-primary)] hover:border-[var(--success)]/30 hover:shadow-lg transition-all duration-300">
            <div className="mb-3 sm:mb-4">
              <svg className="w-8 h-8 sm:w-10 sm:h-10 text-[var(--success)]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
