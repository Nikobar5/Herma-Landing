...
const MobileStickyCTA = () => {
  ...
  return (
    <div className="md:hidden fixed bottom-0 left-0 right-0 z-50 animate-slide-up">
      <div
        className="bg-[var(--bg-primary)] border-t border-[var(--border-secondary)] px-4 pt-3"
        style={{ paddingBottom: 'max(12px, env(safe-area-inset-bottom, 0px))', boxShadow: '0 -4px 20px rgba(232, 149, 106, 0.18)' }}
      >
        <button
        ...
        >
          {isAuthenticated ? 'Go to Dashboard' : 'Get started free — $1 credit included'}
