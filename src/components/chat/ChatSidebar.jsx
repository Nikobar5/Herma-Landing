  ...
  const sidebar = (
    <div className="flex flex-col h-full bg-[var(--bg-secondary)] border-r border-[var(--border-primary)] relative overflow-hidden">
      ...
      <div className="border-t border-[var(--border-primary)] p-4 space-y-3">
        <a
          href="#/memory"
          className="flex items-center gap-2 px-2 py-1.5 rounded-md text-sm text-[var(--text-secondary)] hover:text-[var(--text-primary)] hover:bg-[var(--bg-hover)] transition-colors"
