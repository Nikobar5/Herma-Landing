    ...
    <div className="flex flex-col h-full bg-[var(--highlight-color)] text-white">
      ...
      <div className="p-3">
        <button
          ...
          className="w-full flex items-center gap-2 px-3 py-2.5 rounded-lg bg-white/10 hover:bg-white/20 transition-colors text-sm font-medium"
      ...
      <div className="px-4 py-1.5">
        <span className="text-[10px] font-medium uppercase tracking-wider text-white/40" style={{ fontFamily: 'var(--font-ui)' }}>
          Recent
        </span>
      </div>
            ...
            {editingId === conv.id ? (
              ...
              <>
                <button
                  ...
                  className="flex-1 text-left px-3 py-2.5 text-sm truncate text-white/90"
                  style={{ fontFamily: 'var(--font-body)' }}
                  title={conv.title}
                >
                  <div className="flex items-center gap-2">
                    <svg className="w-3.5 h-3.5 flex-shrink-0 text-white/40" fill="none" viewBox="0 0 24 24" stroke="currentColor">
