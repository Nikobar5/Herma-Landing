        ...
        <div className="container max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <div className="space-y-5 text-base sm:text-lg text-[var(--text-secondary)] leading-relaxed" style={{ fontFamily: 'var(--font-body)' }}>
              ...
              <p>
                Herma exists because we believe all intelligence should flow through one gateway. When developers and teams can seamlessly access the best AI for every task — models, agents, and tools — without managing fragmented infrastructure, they build better, faster, and more creatively.
              </p>
              <p>
              ...
              <p>
                We're building Herma to be the intelligent layer between people and AI — connecting every request to the right intelligence, remembering context, and giving teams full visibility into how AI is being used. One API, one interface, every model and agent.
              </p>
            </div>
          </div>
        </div>
