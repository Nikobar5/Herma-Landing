...
const Overview = () => {
  ...
  return (
    <div className="space-y-8 animate-fade-in">
      ...
      {/* Add Credits CTA */}
      <div className="flex items-center justify-between gap-4 px-6 py-5 rounded-2xl bg-[var(--bg-secondary)] border border-[var(--border-primary)]">
        <div>
          <p className="text-base font-semibold text-[var(--text-primary)]" style={{ fontFamily: 'var(--font-ui)' }}>
            Need more credits?
          </p>
          <p className="text-sm text-[var(--text-secondary)] mt-0.5" style={{ fontFamily: 'var(--font-body)' }}>
            Top up your balance or set up auto-recharge to never run out.
          </p>
        </div>
        <Link
          to="/dashboard/billing"
          className="flex-shrink-0 px-5 py-2.5 font-semibold rounded-xl bg-[var(--accent-primary)] text-[var(--text-inverse)] hover:bg-[var(--accent-hover)] transition-colors"
          style={{ fontFamily: 'var(--font-ui)' }}
        >
          Add Credits
        </Link>
